...
dependencies {
    implementation("io.javalin.community.routing:routing-annotated:7.2.0") // was 6.x
    // or
    implementation("io.javalin.community.routing:routing-dsl:7.2.0")
    // or
    implementation("io.javalin.community.routing:routing-coroutines:7.2.0")
}
```
